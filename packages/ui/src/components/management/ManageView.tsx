...
import { addLink, updateLink, deleteLink, resetLinks } from '@weiz-nav/store/slices/linksSlice';
import {
  resetCategories,
  defaultCategories,
  updateCategory,
...
export function ManageView({ onBack }: ManageViewProps) {
  ...
  return (
    <div className="h-screen flex flex-col bg-(--background) transition-theme">
      {/* 页头 */}
      <header
        className="flex-none w-full bg-(--background-main) border-b border-gray-200 dark:border-neutral-700 transition-theme"
        role="banner"
      >
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
              ...
              <div className="flex flex-wrap gap-2 lg:gap-4">
                  ...
                  <Button
                    ...
                    aria-label={
                      selectedRowKeys.length > 0
                        ? `批量删除选中的 ${selectedRowKeys.length} 个链接`
                        : '批量删除'
                    }
                  >
                ...
                <Button
                  ...
                  aria-label={
                    selectedRowKeys.length > 0
                      ? `批量分类选中的 ${selectedRowKeys.length} 个链接`
                      : '批量分类'
                  }
                >
