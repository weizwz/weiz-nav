...
export const defaultLinks: Link[] = [
  ...
  createLink('163邮箱', 'https://mail.163.com', '中文邮箱第一品牌', '主页', 'https://api.iconify.design/arcticons/netease-mail.svg?color=%23ffffff', '#db0716'),
  ...
  createLink('Nuxt.js', 'https://nuxt.com', '基于 Vue.js 的通用应用框架', '技术框架', 'https://cdn.simpleicons.org/nuxt/ffffff', '#00dc82', 0.6),
  ...
  createLink('TailwindCSS', 'https://www.tailwindcss.cn', '功能类优先的 CSS 框架', '技术框架', 'https://cdn.simpleicons.org/tailwindcss/ffffff', '#16bcff', 0.6),
  ...
  createLink('iconfont', 'https://www.iconfont.cn/', '流行的矢量图标库', '技术框架', 'https://favicon.im/www.iconfont.cn?larger=true', '#000000', 0.6),

  // 工具软件
  createLink('ThisCover', 'https://cover.weizwz.com/', '一个免费、漂亮的封面生成器', '工具软件', 'https://p.weizwz.com/cover/cover_full_441653186ab35580.webp', '#4c38da', 1.0),
  createLink('Can I use', 'https://caniuse.com', '前端 API 兼容性查询', '工具软件', 'https://caniuse.com/img/favicon-128.png', '#f2e8d4'),
  createLink('TinyPNG', 'https://tinypng.com', '在线图片压缩工具', '工具软件', 'https://tinypng.com/images/apple-touch-icon.png', '#ffffff', 0.6),
  createLink('在线工具', 'https://tool.lu/tool', '开发人员的工具箱', '工具软件', 'https://tool.lu/favicon.ico', '#019a61', 0.6),
  ...
  createLink('AST Explorer', 'https://astexplorer.net/', '探索由各种解析器生成的 AST 语法树', '工具软件', 'https://favicon.im/astexplorer.net?larger=true', '#bae0ff', 0.6),
  createLink('Apifox', 'https://www.apifox.cn/', 'API 文档、调试、Mock、自动化测试', '工具软件', 'https://api.iconify.design/simple-icons/apifox.svg?color=%23ffffff', '#fe4b6e', 0.6),
  ...
  createLink('Postman', 'https://www.postman.com/', 'API 开发协作平台', '工具软件', 'https://cdn.simpleicons.org/postman/ffffff', '#ff6c37', 0.6),
  createLink('Swagger', 'https://swagger.io/', 'API 文档和设计工具', '工具软件', 'https://cdn.simpleicons.org/swagger/ffffff', '#85ea2d', 0.6),
